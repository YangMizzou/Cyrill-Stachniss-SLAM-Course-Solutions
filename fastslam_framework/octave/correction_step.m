...
for i = 1:numParticles
  ...
  for j = 1:m
    ...
    if (particles(i).landmarks(l).observed == false)
      ...
      particles(i).weight = particles(i).weight * 1/sqrt(det(2*pi*Q_m)) * exp(-1/2 * diff_m' * inv(Q_m) * diff_m);
