...
for eid = 1:length(g.edges)
  ...
  elseif (strcmp(edge.type, 'L')~= 0)
    ...
    H(edge.fromIdx:edge.fromIdx+2,edge.fromIdx:edge.fromIdx+2) = H(edge.fromIdx:edge.fromIdx+2,edge.fromIdx:edge.fromIdx+2) + A'* edge.information * A;
    H(edge.fromIdx:edge.fromIdx+2,edge.toIdx:edge.toIdx+1) = H(edge.fromIdx:edge.fromIdx+2,edge.toIdx:edge.toIdx+1) + A'* edge.information * B;
    H(edge.toIdx:edge.toIdx+1,edge.fromIdx:edge.fromIdx+2) = H(edge.toIdx:edge.toIdx+1,edge.fromIdx:edge.fromIdx+2) + B'* edge.information * A;
