...
for i = 1:numParticles
  ...
  u.t = u.t + transNoise*randn(1);
  u.r1 = u.r1 + r1Noise*randn(1);
  u.r2 = u.r2 + r2Noise*randn(1);
  dx = u.t*cos(particles(i).pose(3) + u.r1);
  dy = u.t*sin(particles(i).pose(3) + u.r1);
  dtheta = normalize_angle(u.r1 + u.r2);
  particles(i).pose = particles(i).pose + [dx;dy;dtheta];
